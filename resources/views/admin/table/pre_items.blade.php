                    ...
                    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                        <div class="widget-content widget-content-area br-6">
                            <div class="table-responsive mt-4 mb-4">
                                ...
                                {{-- ADD BTN --}}
                                <button class="btn btn-success glyphicon glyphicon-plus add-modal" data-toggle="modal" data-target="#addDiv">新增事前預約贈品
                                </button>
                                {{-- ADD END --}}
                                            ...
                                            <div class="modal-content">
                                              <div class="modal-header">
                                               ...
                                               <form name="form1" method="POST"> 
                                                @csrf
                                                <div class="mb-3">
                                                  <label for="box_id" class="form-label">寶箱ID</label>
                                                  <input type="text" class="form-control" id="box_id" name="box_id">
                                                  <div class="form-text"></div>
                                                </div>
                                          
                                                <div class="mb-3">
                                                  <label for="pre_id" class="form-label">事前預約ID</label>
                                                  <input type="text" class="form-control" id="pre_id" name="pre_id">
                                                  <div class="form-text"></div>
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                  <label for="validity_period" class="form-label">有效時間 </label>
