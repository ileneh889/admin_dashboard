                    ...
                    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                        <div class="widget-content widget-content-area br-6">
                            <div class="table-responsive mt-4 mb-4">
                                ...
                                {{-- ADD BTN --}}
                                <button class="btn btn-success glyphicon glyphicon-plus add-modal" data-toggle="modal" data-target="#addDiv">新增扭蛋機台
                                </button>
                                {{-- ADD END --}}
                                            ...
                                            <div class="modal-content">
                                              <div class="modal-header">
                                               ...
                                               <form name="form1" method="POST"> 
                                                @csrf
                                                <div class="mb-3">
                                                  <label for="machine_name" class="form-label">扭蛋機名稱</label>
                                                  <input type="text" class="form-control" id="machine_name" name="machine_name">
                                                  <div class="form-text"></div>
                                                </div>
                                          
                                                <div class="mb-3">
                                                  <label for="quest_level" class="form-label">限制等級</label>
                                                  <input type="text" class="form-control" id="quest_level" name="quest_level">
                                                  <div class="form-text"></div>
                                                </div>
                                          
                                                <div class="mb-3">
                                                  <label for="max_gacha" class="form-label">扭蛋總量 </label>
                                                  <input type="text" class="form-control" id="max_gacha" name="max_gacha">
                                                  <div class="form-text"></div>
                                                </div>

                                                <div class="mb-3">
                                                  <label for="ticket_price" class="form-label">參加費用 </label>
                                                  <input type="text" class="form-control" id="ticket_price" name="ticket_price">
                                                  <div class="form-text"></div>
                                                </div>

                                                <div class="mb-3">
                                                  <label for="available" class="form-label">是否開放</label>
                                                  <input type="text" class="form-control" id="available" name="available">
                                                  <div class="form-text"></div>
                                                </div>

                                                <div class="mb-3">
                                                  <label for="time_start" class="form-label">開始時間</label>
                                                  <input type="text" class="form-control" id="time_start" name="time_start">
                                                  <div class="form-text"></div>
                                                </div>

                                                <div class="mb-3">
                                                  <label for="time_end" class="form-label">結束時間</label>
