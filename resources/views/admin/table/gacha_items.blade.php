                    ...
                    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                        <div class="widget-content widget-content-area br-6">
                            <div class="table-responsive mt-4 mb-4">
                                ...
                                {{-- ADD BTN --}}
                                <button class="btn btn-success glyphicon glyphicon-plus add-modal" data-toggle="modal" data-target="#addDiv">新增扭蛋
                                </button>
                                {{-- ADD END --}}
                                            ...
                                            <div class="modal-content">
                                              <div class="modal-header">
                                               ...
                                               <form name="form1" method="POST"> 
                                                @csrf
                                                <div class="mb-3">
                                                  <label for="item_id" class="form-label">物品ID</label>
                                                  <input type="text" class="form-control" id="item_id" name="item_id">
                                                  <div class="form-text"></div>
                                                </div>
                                          
                                                <div class="mb-3">
                                                  <label for="name" class="form-label">物品名稱</label>
                                                  <input type="text" class="form-control" id="name" name="name">
                                                  <div class="form-text"></div>
                                                </div>
                                          
                                                <div class="mb-3">
                                                  <label for="machine_id" class="form-label">扭蛋機ID</label>
                                                  <input type="text" class="form-control" id="machine_id" name="machine_id">
                                                  <div class="form-text"></div>
                                                </div>

                                                <div class="mb-3">
                                                  <label for="gacha_prob" class="form-label">扭蛋的機率</label>
                                                  <input type="text" class="form-control" id="gacha_prob" name="gacha_prob">
                                                  <div class="form-text"></div>
                                                </div>

                                                <div class="mb-3">
                                                  <label for="inventory" class="form-label">遊戲世界庫存</label>
                                                  <input type="text" class="form-control" id="inventory" name="inventory">
                                                  <div class="form-text"></div>
                                                </div>
                                                <div class="mb-3">
                                                  <label for="validity_period" class="form-label">有效期限</label>
                                                  <input type="text" class="form-control" id="validity_period" name="validity_period">
                                                  <div class="form-text"></div>
                                                </div>
