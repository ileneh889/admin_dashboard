...
<head>
  ...
  <link href="{{asset(ADMIN_PLUGINS.'/apex/apexcharts.css')}}" rel="stylesheet" type="text/css">
  <link href="{{asset(ADMIN_CSS.'/dashboard/dash_2.css')}}" rel="stylesheet" type="text/css" />
...
<body class="alt-menu sidebar-noneoverflow">
                ...
                <div class="table-responsive">
                  <table class="table">
                    ...
                    <tbody>
                      <tr>
                        <td>
                          <div class="td-content customer-name"><img src="{{asset(ADMIN_IMG.'/90x90.jpg')}}" alt="avatar">Andy King</div>
                        </td>
                        <td>
                      ...
                      <tr>
                        <td>
                          <div class="td-content customer-name"><img src="{{asset(ADMIN_IMG.'/90x90.jpg')}}" alt="avatar">Irene Collins</div>
                        </td>
                        <td>
                      ...
                      <tr>
                        <td>
                          <div class="td-content customer-name"><img src="{{asset(ADMIN_IMG.'/90x90.jpg')}}" alt="avatar">Laurie Fox</div>
                        </td>
                        <td>
                      ...
                      <tr>
                        <td>
                          <div class="td-content customer-name"><img src="{{asset(ADMIN_IMG.'/90x90.jpg')}}" alt="avatar">Luke Ivory</div>
                        </td>
                        <td>
                      ...
                      <tr>
                        <td>
                          <div class="td-content customer-name"><img src="{{asset(ADMIN_IMG.'/90x90.jpg')}}" alt="avatar">Ryan Collins</div>
                        </td>
                        <td>
                      ...
                      <tr>
                        <td>
                          <div class="td-content customer-name"><img src="{{asset(ADMIN_IMG.'/90x90.jpg')}}" alt="avatar">Nia Hillyer</div>
                        </td>
                        <td>
                      ...
                      <tr>
                        <td>
                          <div class="td-content customer-name"><img src="{{asset(ADMIN_IMG.'/90x90.jpg')}}" alt="avatar">Sonia Shaw</div>
                        </td>
                        <td>
                ...
                <div class="table-responsive">
                  <table class="table">
                    ...
                    <tbody>
                      <tr>
                        <td>
                          <div class="td-content product-name"><img src="{{asset(ADMIN_IMG.'/90x90.jpg')}}" alt="product">Speakers</div>
                        </td>
                        <td>
                      ...
                      <tr>
                        <td>
                          <div class="td-content product-name"><img src="{{asset(ADMIN_IMG.'/90x90.jpg')}}" alt="product">Sunglasses</div>
                        </td>
                        <td>
                      ...
                      <tr>
                        <td>
                          <div class="td-content product-name"><img src="{{asset(ADMIN_IMG.'/90x90.jpg')}}" alt="product">Watch</div>
                        </td>
                        <td>
                      ...
                      <tr>
                        <td>
                          <div class="td-content product-name"><img src="{{asset(ADMIN_IMG.'/90x90.jpg')}}" alt="product">Laptop</div>
                        </td>
                        <td>
                      ...
                      <tr>
                        <td>
                          <div class="td-content product-name"><img src="{{asset(ADMIN_IMG.'/90x90.jpg')}}" alt="product">Camera</div>
                        </td>
                        <td>
                      ...
                      <tr>
                        <td>
                          <div class="td-content product-name"><img src="{{asset(ADMIN_IMG.'/90x90.jpg')}}" alt="product">Shoes</div>
                        </td>
                        <td>
                      ...
                      <tr>
                        <td>
                          <div class="td-content product-name"><img src="{{asset(ADMIN_IMG.'/90x90.jpg')}}" alt="product">Headphone</div>
                        </td>
                        <td>
  ...
  <script src="{{asset(ADMIN_JS.'/dashboard/dash_2.js')}}"></script>
  <!-- BEGIN PAGE LEVEL PLUGINS/CUSTOM SCRIPTS -->
