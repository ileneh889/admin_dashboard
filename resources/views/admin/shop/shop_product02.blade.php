...
<head>
  ...
  <link href="{{asset(ADMIN_CSS)}}/apps/contacts.css" rel="stylesheet" type="text/css" />
    <link rel="stylesheet" type="text/css" href="{{asset(ADMIN_PLUGINS)}}/select2/select2.min.css">
...
<body class="alt-menu sidebar-noneoverflow">
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          <button id="btn-edit" class="float-left btn">儲存</button>

                          <button class="btn" data-dismiss="modal"> <i class="flaticon-delete-1"></i>取消</button>
                ...
                <div class="items items-header-section">
                  <div class="item-content">
                    ...
                    <div class="user-location">
                      <h4 style="margin-left: 0;">類別</h4>
                    </div>
                    <div class="user-phone">
                      <h4 style="margin-left: 3px;">價格</h4>
                    </div>
                    <div class="user-phone">
                      <h4 style="margin-left: 3px;">狀態</h4>
                    </div>
                    <div class="user-phone">
                      <h4 style="margin-left: 3px;">售出數量</h4>
                    </div>
                ...
                <div class="items">
                  <div class="item-content">
                    <div class="user-profile">
                      ...
                      <img src="{{asset(ADMIN_IMG)}}/shop/item01.jpg" alt="avatar" width="270">
                      <div class="user-meta-info">
                        <p class="user-name" data-name="Alan Green">聖劍之心</p>
                        <p class="text-center user-work" data-occupation="Web Developer" style="width: 40%;"></p>
                      </div>
                    </div>
                    <div class="user-email">
                      <p class="info-title">類別: </p>
                      <p class="usr-email-addr" data-email="alan@mail.com">傳奇級武器，提升角色戰鬥力。效果持久且強力，是線上遊戲中不可或缺的戰鬥利器。</p>
                    </div>
                    <div class="user-location">
                ...
                <div class="items">
                  <div class="item-content">
                    <div class="user-profile">
                      ...
                      <img src="{{asset(ADMIN_IMG)}}/shop/item02.jpg" alt="avatar" width="270">
                      <div class="user-meta-info">
                ...
                <div class="items">
                  <div class="item-content">
                    <div class="user-profile">
                      ...
                      <img src="{{asset(ADMIN_IMG)}}/shop/item03.jpg" alt="avatar" width="270">
                      <div class="user-meta-info">
                ...
                <div class="items">
                  <div class="item-content">
                    <div class="user-profile">
                      ...
                      <img src="{{asset(ADMIN_IMG)}}/shop/item04.jpg" alt="avatar" width="270">
                      <div class="user-meta-info">
                ...
                <div class="items">
                  <div class="item-content">
                    <div class="user-profile">
                      ...
                      <img src="{{asset(ADMIN_IMG)}}/shop/item05.jpg" alt="avatar" width="270">
                      <div class="user-meta-info">
  ...
  <script src="{{asset(ADMIN_JS)}}/apps/contact.js"></script>
    <script src="{{asset(ADMIN_JS)}}/js/scrollspyNav.js"></script>
