                ...
                <div class="widget-content widget-content-area br-6">
                    <div class="table-responsive mb-4 mt-4">
                        ...
                        <form action="" method="post" class="w-50 m-auto">
                            ...
                            <input type="text" class="form-control" name="title" value="{{ old('title') }}" id="title"><br>
                            @error('title')
                            <span class='text-danger'>{{ $message }}</span><br>
                            @enderror
                            {{-- user_id --}}
                            ...
                            <input type="text" class="form-control" name="category_id" value="{{ old('category_id') }}" id="category_id"><br>
                            @error('category_id')
                            <span class='text-danger'>{{ $message }}</span><br>
                            @enderror
                            {{-- description --}}
                            ...
                            <input type="text" class="form-control" name="price" value="{{ old('price') }}" id="price"><br>
                            @error('price')
                            <span class='text-danger'>{{ $message }}</span><br>
                            @enderror
                            {{-- image_path --}}
                            <label for="image_path">image_path</label>
                            <input type="text" class="form-control" name="image_path" value="{{ old('image_path') }}" id="image_path"><br>
                            @error('image_path')
                            <span class='text-danger'>{{ $message }}</span><br>
                            @enderror
                            {{-- submit --}}
